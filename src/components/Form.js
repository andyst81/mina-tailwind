...
const Form = () => {
  return (
    <section className="text-gray-700 body-font" id="contact">
      <div className="container py-24 lg:w-1/2 md:w-2/3 mx-auto">
        ...
        <div className="flex lg:w-3/4 w-full sm:flex-row flex-col mx-auto px-8 sm:px-0 items-end">
